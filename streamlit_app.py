                ...
                with st.spinner("GIF 파일을 생성하는 중입니다... (수초 소요)"):
                    try:
                        ...
                        for year in years:
                            ...
                            # 이미지로 변환
                            img_bytes = pio.to_image(fig_static, format="png", width=1200, height=600)
                        ...
                        st.info("💡 Kaleido 패키지가 필요합니다. 터미널에서 'pip install kaleido' 명령어를 실행해주세요.")
